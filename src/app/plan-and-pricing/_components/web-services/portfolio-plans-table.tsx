...
const PortfolioPlansTable = () => (
    <div className="w-full max-w-6xl mx-auto my-16">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Portfolio Plans and Pricing</h2>
...
export default PortfolioPlansTable; 