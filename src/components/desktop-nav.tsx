...
function NavItemComponent({ item, index, isActive, setActiveIndex, isLast }: NavItemComponentProps) {
    ...
    return (
        ...
        >
            <button
                className={`flex w-full items-center justify-between rounded-md px-3 py-2 text-sm text-gray-700 ${isActive ? "bg-primary/5 text-primary" : "hover:bg-primary/5 hover:text-primary"}`}
            >
                {item.title}
